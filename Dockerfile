...
RUN --mount=type=cache,id=omniroute-base-apt-cache,target=/var/cache/apt,sharing=shared \
  --mount=type=cache,id=omniroute-base-apt-lists,target=/var/lib/apt/lists,sharing=shared \
  apt-get update \
  && apt-get upgrade -y \
...
RUN --mount=type=cache,id=omniroute-builder-apt-cache,target=/var/cache/apt,sharing=shared \
  --mount=type=cache,id=omniroute-builder-apt-lists,target=/var/lib/apt/lists,sharing=shared \
  apt-get update \
...
RUN --mount=type=cache,id=omniroute-builder-npm,target=/root/.npm \
...
RUN --mount=type=cache,id=omniroute-runner-web-apt-cache,target=/var/cache/apt,sharing=locked \
  --mount=type=cache,id=omniroute-runner-web-apt-lists,target=/var/lib/apt/lists,sharing=locked \
  apt-get update \
...
RUN --mount=type=cache,id=omniroute-runner-cli-apt-cache,target=/var/cache/apt,sharing=locked \
  --mount=type=cache,id=omniroute-runner-cli-apt-lists,target=/var/lib/apt/lists,sharing=locked \
  apt-get update \
...
RUN --mount=type=cache,id=omniroute-runner-cli-npm,target=/root/.npm \
